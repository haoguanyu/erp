...
class PHPExcel
{
	...
	*/
	...
	public function __construct()
	{
        ...
        //set width  设置表格宽度
        $this->getActiveSheet()->getColumnDimension('A')->setWidth(8);
        $this->getActiveSheet()->getColumnDimension('B')->setWidth(10);
        $this->getActiveSheet()->getColumnDimension('C')->setWidth(29);
        $this->getActiveSheet()->getColumnDimension('D')->setWidth(10);
        ...
        $this->getActiveSheet()->getColumnDimension('H')->setWidth(9);
        // $this->getActiveSheet()->getColumnDimension('I')->setWidth(15);
        // $this->getActiveSheet()->getColumnDimension('J')->setWidth(15);
        // $this->getActiveSheet()->getColumnDimension('K')->setWidth(30);

 ...
 * 供应商模型
 */
class ErpSupplierModel extends BaseModel
{
     ...
     * @time 2017-03-31
     */
    public function getSupplierList($where = [], $field = '', $offset = 0, $limit = 10, $order = 'o.id desc')
    {
        $data['recordsTotal'] = $this->getSupplierCount($where);
...
//            ->join('oil_erp_storehouse es on o.storehouse_id = es.id', 'left')
     ...
     * @time 2017-03-31
     */
    public function saveSupplier($where = [], $data = [])
    {
     ...
     * @time 2017-03-31
     */
    public function findSupplier($where = [], $field = true)
    {
